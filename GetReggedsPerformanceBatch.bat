...
curl -g -k -L -# -o "%temp%\NvidiaProfileInspector\ancel_nv_profile.nip" "https://github.com/ancel1x/Ancels-Performance-Batch/raw/main/bin/ancel_nv_profile.nip" >nul 2>&1
start "" /wait "%temp%\NvidiaProfileInspector\nvidiaProfileInspector.exe" -silentImport "C:\NvidiaProfileInspector\ancel_nv_profile.nip" >nul 2>&1
timeout /t 3 /nobreak >nul 2>&1
